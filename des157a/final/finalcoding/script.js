(function(){
    ...
    finishButton.addEventListener('click', function(event){
        ...
        if (adjective1 && number2 && noun1 && noun2 && personintheroom && verb1 && noun3 && char1Clicked === true) {
            ...
            myText = `<p class = "madlibtext">Here's Your Story!<br><br>After killing your <span class = "red">${adjective1}</span> boss for not paying you for your check of <span class = "red">${number2}</span> thousand dollars, you're thinking about entering the Squid Games to buy your wife the <span class = "red">${noun1}</span> she's always wanted. In the chaotic fight after the second game, you protect your friends with a cold, steel <span class = "red">${noun2}</span> and help them in Tug-of-War by holding it down with your <span class = "red">${bodypart}</span> which helps your puny teammate, <span class = "red">${bodypart}</span>, from falling. Your character, Abdul Ali, wandered off during the fourth game and mentioned that he saw a K-Pop star sneaking around. Uhm, play again to find the winner!</p>`;
